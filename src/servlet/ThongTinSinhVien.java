...
public class ThongTinSinhVien extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (username != null) {
		    ...
		    List<ThongTinNguoiDung> quanlysinhvien = new ArrayList<ThongTinNguoiDung>();
		    ...
		    try {
				c = connect.DBConnect.getConnection();
				String slql = "select * from taikhoan,nguoidung where taikhoan.MaNguoiDung = nguoidung.MaNguoiDung and nguoidung.MaLoaiNguoiDung = 3";
		    ...
		    request.setAttribute("quanlysinhvien", quanlysinhvien);
			request.getRequestDispatcher("/WEB-INF/thongtinsinhvien.jsp").forward(request, response);
		}
		else
