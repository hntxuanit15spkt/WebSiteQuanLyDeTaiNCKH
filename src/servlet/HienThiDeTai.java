...
public class HienThiDeTai extends HttpServlet {
   ...
   * Class.forName("com.mysql.jdbc.Driver");// initialize jdbc driver } catch
   * (ClassNotFoundException e) { throw new ServletException(e); } }
   */
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      /*
       * String url =
       * "jdbc:mysql://localhost/quanlydetainghiencuukhoahoc?user=root&password=15110376"; c =
      ...
      while (rs.next()) {
        DeTai dt = new DeTai(rs.getInt("MaDeTai"), rs.getString("TenDeTai"),
                  rs.getString("PhuongPhapThucHien"), rs.getString("KinhPhi"),
                  rs.getString("LoaiDeTai"));
        lstDeTai.add(dt);
      }
