    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (username != null) {
			...
			try {
			    ...
			    while (rs.next()) {
				DeTai dt = new DeTai(rs.getString("HoTen"), rs.getString("TenLoaiNguoiDung"), rs.getString("TenDeTai"), rs.getString("MucTieu"), rs.getString("TenTrangThai"), rs.getDate("ThoiGianBatDau"), rs.getDate("ThoiGianKetThuc"), rs.getDate("ThoiGianPhanBien"));
				lstDeTai.add(dt);
			    }
