	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (username != null) {
		    ...
		    try {
				...
				while (rs.next()) {
					ThongTinNguoiDung quanlygv = new ThongTinNguoiDung(rs.getString("TenDangNhap"), rs.getString("MatKhau"), rs.getString("HoTen"), rs.getString("SoDienThoai"), rs.getDate("NgaySinh"), rs.getBoolean("TrangThaiNguoiDung"));
