	...
	<div class="wrapper">
		<div class="sidebar" data-color="purple"
			...
			<div class="sidebar-wrapper">
				<ul class="nav">
					<li class="active"><a href="trangchu"> <i
				...
				<div class="container-fluid">
					<div class="col-md-12">
						<div class="fresh-table toolbar-color-azure">
							...
							<form action="PhanCongHoiDongPhanBienDeTai" method="post">
								<input type="hidden" value="${maDeTai_PhanCongPhanBien}"
									name="maDeTai_PhanCongPhanBien" />
								<div class="col-md-4">
									<label class="col-md-8 control-label">Đặt tên hội đồng
										phản biện</label>
									<div class="col-md-8 inputGroupContainer">
										<input type="text" class="form-control" value=""
											name="tenhoidongphanbien"
											placeholder="Nhập vào tên hội đồng phản biện" />
									</div>
								</div>
								<!-- Đặt tên hội đồng phản biện: <input type="text"
									name="tenhoidongphanbien"
									placeholder="Đặt tên cho hội đồng phản biện" /> -->
								<table id="fresh-table" class="table">
									<thead>
										<tr>
											<th data-field="id" data-sortable="true">Mã giảng viên</th>
											<th data-field="salary" data-sortable="true">Tên giảng
												viên</th>
											<th data-field="country" data-sortable="true">Tên bộ môn</th>
											<th data-field="actions">Thao tác</th>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${lstGiangVien}" var="detai">
											<tr>
												<td>${detai.getMaNguoiDung() }</td>
												<td>${detai.getHoTen() }</td>
												<td>${detai.getTenBoMon() }</td>
												<td><input type="checkbox"
													value="${detai.getMaNguoiDung() }" name="giangvien" /></td>
												<%-- <td><a
								...
								<button type="submit" class="btn btn-info btn-lg">Xác
									nhận phân công</button>
							</form>
						</div>
					</div>
				</div>
