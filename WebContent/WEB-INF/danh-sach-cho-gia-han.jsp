								...
								<thead>
									<tr>
										...
										<th data-field="country" data-sortable="true">Thời gian
											kết thúc</th>
											<th data-field="country" data-sortable="true">Thời gian xin gia hạn</th>
								...
								<tbody>
									<c:forEach items="${lstDeTaiCanDuyet}" var="detai">
										<tr>
											...
											<td>${detai.getNgayXinGiaHan() }</td>
											<td><a
												href="ChiTietDeTai_XemXetGiaHanDeTai?madetai=${detai.getMaDeTai()}&magiangvienhuongdan=${detai.getMaGiangVienHuongDan()}"
