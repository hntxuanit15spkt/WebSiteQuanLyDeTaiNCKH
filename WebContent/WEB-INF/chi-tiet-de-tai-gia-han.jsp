...
<body>
	<div class="wrapper">
		...
		<div class="main-panel">
			...
			<div class='content'>
				<form class="form-horizontal" action="DanhSachChoDuyet"
					...
					<div class="form-group">
						...
						<div class="col-md-8  inputGroupContainer">
							<input name="tendetai" placeholder="Nhập vào tên đề tài của bạn"
								...
								value="${ThongTin_DeTai.getTenDeTai()}" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-4 control-label">Mục tiêu</label>
						<div class="col-md-8  inputGroupContainer">
							<input name="muctieu" disabled
								value="${ThongTin_DeTai.getMucTieu()}"
								placeholder="
								Nhập vào mục tiêu của bạn"
					...
					<div class="form-group">
						...
						<div class="col-md-8  inputGroupContainer">
							<textarea name="motaytuong" disabled class="form-control"
								rows="5">${ThongTin_DeTai.getTenDeTai()}</textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-4 control-label">Tính cấp thiết</label>
						<div class="col-md-8  inputGroupContainer">
							<textarea name="tinhcapthiet" disabled class="form-control"
								rows="5">${ThongTin_DeTai.getTenDeTai()}</textarea>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-8  inputGroupContainer">
							<input name="linhvucnghiencuu" disabled
								value="${ThongTin_DeTai.getLinhVucNghienCuu()}"
								placeholder="
								Lĩnh vực của đề tài là gì?"
								class="form-control" type="text" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-4 control-label">Phương pháp thực
							hiện</label>
						<div class="col-md-8  inputGroupContainer">
							<textarea name="phuongphapthuchien" class="form-control" disabled
								rows="5" placeholder="Trình bày sơ lược phương pháp nghiên cứu">${ThongTin_DeTai.getPhuongPhapThucHien()}</textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-4 control-label">Kinh phí dự kiến</label>
						<div class="col-md-8  inputGroupContainer">
							<textarea disabled name="kinhphi" class="form-control" rows="5">${ThongTin_DeTai.getKinhPhi()}</textarea>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-8 inputGroupContainer">
							<input type="date" class="form-control" disabled
								value="${ThongTin_DeTai.getThoiGianBatDau()}"
								name='thoigianbatdau' />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-8 inputGroupContainer">
							<input type="date" class="form-control" disabled
								value="${ThongTin_DeTai.getThoiGianKetThuc()}"
					...
					<div class="Thongtinsinhvien1">
						...
						<div class=col-md-6>
							<div class="form-group">
								...
								<div class="col-md-8 inputGroupContainer">
									<input type="text" class="form-control" disabled
										value="${ThongTin_SinhVien.getHoTen()}" name="hoten"
							...
							<div class="form-group">
								...
								<div class="col-md-8 inputGroupContainer">
									<input type="text" class="form-control" disabled
										value="${ThongTin_SinhVien.getMaSo()}" name="masosinhvien"
							...
							<div class="form-group">
								...
								<div class="col-md-8 inputGroupContainer">
									<input type="text" class="form-control" disabled
										value="${ThongTin_SinhVien.getKhoaHoc()}" name="khoahoc"
							...
							<div class="form-group">
								...
								<div class="col-md-8 inputGroupContainer">
									<input type="date" disabled
										value="${ThongTin_SinhVien.getNgaySinh()}"
							...
							<div class="form-group">
								...
								<div class="col-md-8 inputGroupContainer">
									<input type="text" disabled
										value="${ThongTin_SinhVien.getDiaChi()}" class="form-control"
						...
						<div class=col-md-6>
							<div class="form-group">
								...
								<div class="radio">
									<c:if test="${ThongTin_SinhVien.getGioiTinh()}">
										<label><input disabled type="radio" name="gioitinh"
											value="1" checked />Nam</label>
									</c:if>
									<c:if test="${ not ThongTin_SinhVien.getGioiTinh()}">
							...
							<div class="form-group">
								...
								<div class="col-md-8 inputGroupContainer">
									<input type="text" disabled
										value="${ThongTin_SinhVien.getLop()}" class="form-control"
										name="masolop" placeholder="Nhập vào mã số sinh viên" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 inputGroupContainer">
									<input type="text" class="form-control" disabled
										value="${ThongTin_SinhVien.getSoTaiKhoanNganHang()}"
							...
							<div class="form-group">
								...
								<div class="col-md-8 inputGroupContainer">
									<input type="text" disabled
										value="${ThongTin_SinhVien.getSoDienThoai()}"
							...
							<div class="form-group">
								...
								<div class="col-md-8 inputGroupContainer">
									<input type="text" disabled
										value="${ThongTin_SinhVien.getEmail()}" class="form-control"
										name="email" placeholder="Nhập vào email" />
								</div>
							</div>
							<div class="form-group">
								<div class="col-md-4">
									<button type="button"
										...
										class="btn btn-info btn-lg" id="myBtn">
										<a style="color: white;"
											href="
											DongYGiaHanDeTai?madetai=${ThongTin_DeTai.getMaDeTai()}&masinhvien=${ThongTin_SinhVien.getMaNguoiDung()}&ngayxingiahan=${ThongTin_DeTai.getNgayXinGiaHan()}">Đồng
											ý gia hạn</a>
									</button>
								</div>
								<div class="col-md-4">
									<button type="button" class="btn btn-info btn-lg"
										...
										<a style="color: white;"
											href="KhongDongYGiaHanDeTai?madetai=${ThongTin_DeTai.getMaDeTai()}">Không
											đồng ý gia hạn</a>
									</button>
