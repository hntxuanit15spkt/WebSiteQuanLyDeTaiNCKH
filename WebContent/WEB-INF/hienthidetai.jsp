		                        ...
		                        <tbody>
		                     		<c:forEach items="${thongtin}" var="detai">
										<tr>
											...
											<td><fmt:formatDate value="${detai.getThoiGianBatDau() }" pattern="yyyy-MM-dd"/></td>
											<td><fmt:formatDate value="${detai.getThoiGianKetThuc() }" pattern="yyyy-MM-dd"/></td>
											<td><fmt:formatDate value="${detai.getThoiGianPhanBien() }" pattern="yyyy-MM-dd"/></td>
											<td><a href="XoaDeTai?madetai=${detai.getMaDeTai()}" class="btn btn-danger">
