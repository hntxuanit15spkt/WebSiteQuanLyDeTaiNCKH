...
<body>
	<div class="wrapper">
		...
		<div class="main-panel" id='ad_home'>
				...
				<div class="container-fluid">
					...
					<div class="col-md-12">
		                <div class="fresh-table toolbar-color-green">
		                    <div class="toolbar">
		                        <button id="alertBtn" class="btn btn-default">Danh sách sinh viên</button>
		                        <a href='#themsinhvien'><button id="themtaikhoan" class="btn btn-default">Thêm tài khoản</button></a>
		                    </div>
		                    ...
		                    <table id="fresh-table" class="table">
		                        ...
		                        <tbody>
		                     		<c:forEach items="${quanlysinhvien}" var="value">
										<tr>
											...
											<c:if test="${value.getTrangThaiNguoiDung()}">
												<td><i>Còn đang học</i></td>
												<td>
													<form action="ThongTinSinhVien?tendangnhap=${value.getTenDangNhap()}" method="post">
														<a href="EditNguoiQuanLy?tendangnhap=${value.getTenDangNhap()}&maloainguoidung=3" class="btn btn-danger"><span><strong>Khóa</strong></span></a>
														<input type='submit' class="btn btn-danger" value='Xóa'/>
													</form>
												</td>
											</c:if>
											<c:if test="${value.getTrangThaiNguoiDung()==false}">
												<td><i>Đã nghĩ học</i></td>
												<td>
													<form action="ThongTinSinhVien?tendangnhap=${value.getTenDangNhap()}" method="post">
														<input type='submit' class="btn btn-danger" value='Xóa'/>
													</form>
			...
			<div id='themsinhvien' class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					<div class="navbar-header">
						<a class="navbar-brand" href="#themsinhvien"> Thêm sinh viên </a>
					</div>
				</div>
			</div>
			<div id='formthemsinhvien' class='content'>
				<div class="container-fluid">
					<form class="form-horizontal" action="ThemTaiKhoan?maloainguoidung=3" method="post" id="themtaikhoan_form">
						<legend> Thông tin tài khoản </legend>
						<div class="form-group" class='col-md-8 col-md-offset-2'>
							<label class="col-md-4 control-label">Tên đăng nhập</label>
							<div class="col-md-4  inputGroupContainer">
								<input name="tendangnhap" placeholder="Nhập vào mã số sinh viên"
						...
						<div class="form-group" class='col-md-8 col-md-offset-2'>
							...
							<div class="col-md-4  inputGroupContainer">
								<input name="nhaplaimatkhau" placeholder="Nhập lại mật khẩu sinh viên"
							...
							<div class="form-group">
								...
								<div class="col-md-8 inputGroupContainer">
									<input type="text" class="form-control" name="hoten"
										placeholder="Nhập vào họ tên sinh viên" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-8 inputGroupContainer">
									<input type="text" class="form-control" name="khoahoc"
										placeholder="Nhập vào khóa học sinh viên" />
								</div>
							</div>
							<div class="form-group">
