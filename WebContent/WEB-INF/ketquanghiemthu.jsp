		                    ...
		                    <table id="fresh-table" class="table">
		                        <thead>
		                        	<tr>
			                        	...
			                        	<th data-field="salary" data-sortable="true">Điểm nghiệm thu trung bình</th>
			                        	<th data-field="actions">Operation</th>
		                        	</tr>
		                        </thead>
		                        <tbody>
		                     		<c:forEach items="${ketquanghiemthu}" var="nghiemthu">
										<tr>
											<td>${nghiemthu.getMaDeTai() }</td>
											<td>${nghiemthu.getTenDeTai() }</td>
											<td><i>${nghiemthu.getTenTrangThai()}</i></td>
											<td>${nghiemthu.getDiemTrungBinh() }</td>
											<td><a href="ChiTietKetQuaNghiemThu?madetai=${nghiemthu.getMaDeTai()}#chitiet" class="btn btn-danger">
